...
const domain_util_service_1 = require("./domain.util.service");
let UtilModule = class UtilModule {
};
exports.UtilModule = UtilModule;
exports.UtilModule = UtilModule = __decorate([
    (0, common_1.Module)({
        providers: [domain_util_service_1.DomainUtilService],
        exports: [domain_util_service_1.DomainUtilService],
    })
], UtilModule);
